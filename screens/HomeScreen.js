    ...
    <View style={{ backgroundColor: themeColors.bg }} className="flex-1">
      <SafeAreaView className="flex-row justify-between mx-4 items-center">
        ...
        <View className="flex-row items-center space-x-3">
          ...
          <Image source={require('../assets/images/raji.jpg')} 
      ...
      <ScrollView className="flex-1 -mt-6" showsVerticalScrollIndicator={false}>
        {/* categories */}
        <View className="py-10 pb-2">
          <ScrollView className="px-4" horizontal showsHorizontalScrollIndicator={false}>
          <TouchableOpacity>
            <Icon.Menu stroke="white" strokeWidth={1.2} height="22" className= "p-1 px-3 mr-2"/>
          </TouchableOpacity>
